...
public class ThreeSentenceAnnotator extends JCasAnnotator_ImplBase{
	...
	public void process(JCas jCas) throws AnalysisEngineProcessException {
		...
		for (int i = 0; i < segments.length; i++) {
			...
			for (CoreMap sentence : sentences) {
				...
				candSent=previous+previousPrevious+current+" ";
				...
				annSentence
						.setEnd(sentEndPos);// end
																				// of
																				// last
				System.out.println(sentText);																// token

...
public class NGram_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.qalab.types.NGram");
  ...
  public int getElements(int addr) {
      ...
      jcas.throwFeatMissing("elements", "edu.cmu.lti.qalab.types.NGram");
  ...
  public String getElementType(int addr) {
      ...
      jcas.throwFeatMissing("elementType", "edu.cmu.lti.qalab.types.NGram");
  ...
  public int getN(int addr) {
      ...
      jcas.throwFeatMissing("N", "edu.cmu.lti.qalab.types.NGram");
  ...
  public int getOwner(int addr) {
      ...
      jcas.throwFeatMissing("Owner", "edu.cmu.lti.qalab.types.NGram");
  ...
  public NGram_Type(JCas jcas, Type casType) {
    ...
    casFeat_Owner = jcas.getRequiredFeatureDE(casType, "Owner", "uima.tcas.Annotation", featOkTst);
